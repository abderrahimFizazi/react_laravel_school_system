            ...
            <>
                <div
                    ...
                    {isOpen2 ? moduleList.map(item => {
                        return (
                            <div className="dropdown2__item" key={item.id} value={item.designation} onClick={() => { setModule(item.id) ; setModuleDes(item.designation)} }> {item.designation}</div>
                        )
                    }) : null
                    }
                </div>
        ...
        <>
            ...
            <div className="fs-1 text-center my-3 p-2" style={{"color": "#008080"}}>Voir/Inserer Notes</div>
                <div className="row d-flex  justify-content-center" >
                    ...
                    <form className="mx-5" style={{"borderLeft": "solid 6px #008080" , "box-shadow":" 7px 5px 10px #008080" }}>
                        <div className="m-2">
                        ...
                        <Link to={"/admin/insert_notes/" + filiere + "/" + niveau + "/" + module + "/"+element} className="btn m-3 " title="Inserer"> <Bs.BsPencilSquare style={{ fill: "red" }} size={40} /></Link>
                        </form>
                    </div>
                    <div className="col-md-3"></div>
