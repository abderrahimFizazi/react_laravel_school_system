...
class FiliereController extends Controller
{
    protected function store(Request $request){
        ...
        $filiere->id_responsabl = $request->input("id_responsable");
    ...
    protected function index(){
        $filiere = Filiere::select('id' , 'code' , 'designation' , 'id_responsable')->get();
        return response()->json([
            "status" => 200,
            "filiere" => $filiere
        ]);
    ...
    protected function edit($id){
        $filiere = Filiere::find($id)->select('id' , 'code' , 'designation' , 'id_responsable')->get();
        if($filiere){
            return response()->json([
                "status" => 200,
                "filiere" => $filiere
